package external;
/**
 *  Since TicketMaster asked to use GeoPoint instead of 
...
/** 
 *  Since this class has its own main function, 
 *  we can test it yourself by running it as Java Application.
